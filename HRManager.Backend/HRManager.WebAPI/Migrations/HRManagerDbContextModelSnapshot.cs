...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRManager.WebAPI.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRManager.WebAPI.Models.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRManager.WebAPI.Models.Role", b =>
                {
                    ...
                    b.HasIndex("Name", "InstituicaoId")
                        .IsUnique();

                    b.ToTable("Roles", (string)null);
                });

            modelBuilder.Entity("HRManager.WebAPI.Models.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("HRManager.WebAPI.Models.RoleTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HRManager.WebAPI.Models.RolePermission", b =>
                {
                    b.HasOne("HRManager.WebAPI.Models.Permission", "Permission")
